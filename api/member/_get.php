...
if ($requestMethod == 'GET') {
    ...
    if (isset($_GET['classroom'])) {
        ...
        $sql = "SELECT * FROM member WHERE (firstname LIKE '%$search%' OR lastname LIKE '%$search%' OR username LIKE '%$search%' OR email LIKE '%$search%' or sid LIKE '%$search%')";
        $sql.= " AND role=$role AND classroom=$classroom LIMIT $sp,$lp";
        // echo $sql;
...
{
    global $sp, $lp, $sql;
    $sql = "SELECT * FROM member LIMIT $sp, $lp";

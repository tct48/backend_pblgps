...
{
    global $sql;
    $sql = "SELECT * FROM choice WHERE _id=$id";
    return execute_data($sql, "false");
}

function getClause($question){
    global $sql;
    $sql = "SELECT * FROM choice WHERE question=$question";

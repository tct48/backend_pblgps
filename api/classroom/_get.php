...
{
    global $sql;
    $sql = "SELECT * FROM classroom WHERE _id=$id";
...
{
    global $sp, $lp, $sql;
    $sql = "SELECT * FROM classroom LIMIT $sp, $lp";
...
{
    global $sp, $lp, $sql;
    $sql = "SELECT * FROM classroom WHERE name LIKE '%$text%' LIMIT $sp, $lp";
    return execute_data($sql);
}
